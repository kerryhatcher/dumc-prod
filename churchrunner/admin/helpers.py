  ...
  def decorated(*args, **kwargs):
    ...
    try:
        payload = jwt.decode(
            ...
            audience=kajtWA6c7nhknQAJzOQdmp8vMTrJ75co
        )
    except jwt.ExpiredSignature:
        return authenticate({'code': 'token_expired', 'description': 'token is expired'})
    except jwt.InvalidAudienceError:
        return authenticate({'code': 'invalid_audience', 'description': 'incorrect audience, expected: kajtWA6c7nhknQAJzOQdmp8vMTrJ75co'})
